...
var ChatComponent = (function () {
    ...
    ChatComponent.prototype.loadHistory = function () {
        ...
        var channelName = this.currentChannel.channelName;
        this.isChannelHistoryLoading = true;
        this.backend.getHistory(identity, channelName).then(function (messages) {
            var encryptedMessages = _.sortBy(messages, 'dateCreated');
    ...
    ChatComponent.prototype.onMessageAdded = function (message) {
        ...
        if (_.some(this.messages, function (m) { return m.id && m.id == messageObject.id; })) {
            return;
        }
